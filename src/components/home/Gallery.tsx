...
export const Gallery = () => {
  return (
    <section className="relative z-40 grid min-h-[50vh] w-full place-content-center overflow-hidden sm:min-h-[60vh] sm:overflow-visible">
      <h2 className="text-center text-4xl font-bold">My Gallery</h2>
      <Cards />
    </section>
  );
};
